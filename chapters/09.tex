...
As shown in \tabref{tab:Svard:7} and \ref{tab:Svard:8} show, more than half of the languages in the sample have more than four gender-indexing targets.%
\footnote{%
