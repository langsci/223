...
In the sample of this study, sex-based
 ...
 \todo{move bars closer to each other}
\begin{figure}
...
%         x tick label style={rotate=45,anchor=east},
          ...
          \addplot+[lsLightWine] plot coordinates {(New Guinea,0) (Africa,2.4) };
