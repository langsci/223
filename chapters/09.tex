...
As shown in \tabref{tab:Svard:2} and \figref{fig:Svard:2}, sex-based systems are by far the most common ones, with 19 of 20 languages having natural gender as their semantic core. Only the sole \ili{Austronesian} language \ili{Teop} exhibits a non-sex-based system.
...
\ea
\label{ex:Svard:3}
\ili{Nalca} (TNG, \ili{Mek}) (own examples)\\
\begin{xlist}
\ex
...
\end{xlist}
\z
\footnotetext{The overwhelming majority of data available in \ili{Nalca} consists of a translation of the New Testament. The \ili{English} translation used is the American Standard Version, whereas the glossings and literal translations were devised by the present author. For a description and discussion of the methodology, see Svärd (2013) and Wälchli (to appear).}

Finally, the only non-sex-based gender systems in the sample occurs in the \ili{Austronesian} language \ili{Teop}, which has two genders (I and II) with two subgenders for the first gender (I-E and I-A, reflecting the form of the singular article preceding nouns. The genders and the nouns that belong to them are:
...
The second criteria concerns the number of genders in a language, based on \citet{Corbett2013}. Each language is assigned the value two, three, four, or five or more genders (see \tabref{tab:Svard:3} and \figref{fig:Svard:3}). The majority of the languages have only two genders, in all cases sex-based. Only one, \ili{Mian}, has four genders. Of the remaining languages, three languages have three genders, whereas the remaining five languages have five or more genders, viz., \ili{Nalca} (5), \ili{Motuna} (6), \ili{Burmeso} (9 > 3/6),%
\footnote{\ili{Burmeso} has two gender systems, with three genders belonging to the first system and the other six belonging to the second system (see \sectref{sec:Svard:5.2}).} %
...
Number of genders & \ili{No}. of lgs. & \% & Languages\\
\midrule
Two & 11 & 55\% & {Abau}
...
\ili{Rotokas}\\
Four & 1 & 5\% & \ili{Mian}\\
Five or more & 5 & 25\% & {\ili{Nalca} (5)}

{\ili{Motuna} (6)\footnotemark{}}

{\ili{Burmeso} (9 → 3/6)\footnotemark{}}

{\ili{Yimas} ({\textasciitilde}12)}
...
\footnotetext{\citet{Onishi1994} states that \ili{Motuna} has six genders: masculine, feminine, diminutive, local, manner, and dual-paucal. However, the author does not elaborate on gender assignment, and I have been unable to satisfactorily conclude that the dual-paucal is truly a gender, which Onishi states. However, all form a complementary and mutually exclusive system, with separate identifiable markers and where a word may take only one gender.}
%\stepcounter{footnote}
\footnotetext{\ili{Burmeso} has nine genders in total: three belong to the first gender system, whereas six belong to the second.}
...
\stepcounter{footnote}\footnotetext{\ili{Burmeso} adjectives are targets in the first gender system whereas verbs are targets in the second system.}
\stepcounter{footnote}\footnotetext{\ili{Kuot} has no independent third person personal pronouns (Eva Lindström, p.c.). However, demonstratives are used with pronominal functions (see also Footnote \ref{fn:Svard:19} below).}
...
\ea
\label{ex:Svard:5}
\ili{Nalca} (TNG, \ili{Mek}) (own example; repeated from \ref{ex:Svard:3}a)\\
...
On the other hand, \ili{Teop} (\ili{Austronesian}, \ili{Oceanic}) has a very different kind of marking. As mentioned above, \ili{Teop} has a set of articles which obligatorily precede nouns, adjectives, and numerals. Thus, the latter two are indexation, while the articles preceding nouns are considered overt marking. The forms of the markers are shown in \tabref{tab:Svard:12}.
...
\textit{Classification criterion 1: Sex-based and non-sex-based gender systems (\sectref{sec:Svard:3.1}).} In the sample of this study, sex-based systems are by far more common, with only \ili{Teop} (\ili{Austronesian}, \ili{Oceanic}) having a non sex-based system. In comparison, in Di Garbo's (\citealt*[63]{DiGarbo2014}) sample, 48 languages (57\%) had sex-based gender systems and 36 languages (43\%) non-sex-based gender systems. In Corbett's (2013b) sample, 84 languages (75\%) have sex-based systems and 28 (25\%) non-sex-based. A comparison of the percentage distributions is shown in \figref{fig:Svard:7}.
...
\footnotetext{`Non-feminine' in \ili{Skou}.}
...
As seen in the above table, almost a quarter of the languages in the sample have no gender distinctions in independent pronouns. In comparison, only two languages (\ili{Mende} and Menya) have gender distinctions solely in pronouns.
...
Future studies could also investigate the diachrony of gender in New Guinea. Some languages of New Guinea have been found to have diachronically young gender systems, including \ili{Nalca} (TNG, \ili{Mek}) of the sample of the present study, and the prevalence of sex-based systems suggest that many gender systems in New Guinea have diachronic origins different from e.g., the non-sex-based gender systems of Africa.
