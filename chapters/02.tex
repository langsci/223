...
\footnote{See \citetvo{Waelchlithisyear} for a different view on pronominal gender.} %
...
In order to capture the intuition that polyfunctional markers are more complex than dedicated markers, we assume a principle that is well-represented in the complexity literature, the Principle of Transparency (again, I follow the terminology of \citealt{Kusters2003}; \citealt{Miestamo2008} and \citealtvo{DiGarbothisyear} call it ``Principle of One-Meaning-One-Form''). This principle states that:
