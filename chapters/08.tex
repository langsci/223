...
%see also \textcite[170]{Reid1997} for an agreeing placeholder in the \ili{Australian} language \ili{Ngan'gityemerri}.
...
\noindent It is remarkable that Gender IV nouns trigger the use of verb stems otherwise used for 3d person animate plurals, since gender agreement is not manifested elsewhere in person indexing. \ili{No} distinction is made between Gender I and II, and inanimate stems such as \mar{lalig} generally look like separate lexemes rather than inflectional forms of the verb. Some more examples of alternations are given in (\ref{ex:Bruno:stems}).
