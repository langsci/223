...
\ili{Uduk}, a \ili{Koman} language spoken on the border of Ethiopia and Sudan, evinces a
number of unusual characteristics in its system of gender marking.  \ili{Uduk} has two
gender classes, with agreement displayed primarily in the verbal system and
adjacent case-marking particles.  In contrast to related \ili{Koman} languages,
...
manner that nouns would be.  Lastly, \ili{Uduk} shows some unorthodox aspects in the
way it indexes gender on verbs, using what might be considered subtractive
morphology.

This article looks at the complexity and features of gender in \ili{Uduk} from a
...
\textbf{Keywords:}
\ili{Uduk}, gender, assignment, \ili{Koman}, adjacency, ditropic.
}%
\maketitle
...
Semantic assignment is not predictable for human apellatives in \ili{Uduk}; however,
...
By these features as well as some others, \ili{Uduk} has a relatively
...
\ili{Tagalog} or \ili{Fijian}, as the gender of its nouns are generally much less
