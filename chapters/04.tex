...
\ea
\label{ex:Nich:6}
\ili{Ingush} gender markers (\citealt[144]{Nichols2011})\\
...
\ea
\label{ex:Nich:16}
Arhavi \ili{Laz} subject and object indexation paradigm. Only one argument is overt. … = root + thematic suffix. Phonological alternations not shown. (\citealt[283, 298]{Lacroix2009}, plus examples on other pages; s.a.\ \citealt[51]{Oeztuerk2011}.)\\
...
\ea
\label{ex:Nich:18}
Tundra Yukagir\il{Yukaghir, Tundra} obviation: Distribution of transitive markers (\citealt[17]{Maslov2003}). Bracketed comment mine.\\
...
\ea
\label{ex:Nich:19}
Tundra Yukagir\il{Yukaghir, Tundra} obviation: Person slot (the second element of the internally hyphenated forms in (\ref{ex:Nich:17})) in the O focus paradigm (\citealt[20]{Maslov2003}).\\
...
\ea
\label{ex:Nich:20}
Summary of hierarchical effects in Tundra Yukagir\il{Yukaghir, Tundra} obviation. (Recall that Focus = proximate.)\\
