...
\hyphenation{be-stimmtes, re-gel-mä-ßig}
...
This approach is illustrated with the following example from the \ili{Bantu} language \ili{Swahili}, where agreement and nominal form classes are bold-faced in both lines.
...
\llap{*}14  & bu-  \tknode{7A10} & & \tknode{7B10} \llap{*}bu- &  SG, TN\\
...
\padding
\ili{Efutu}, \ili{Gonja}, \ili{Gua-Cherepong}, \ili{Krachi}, \ili{Larteh}, \ili{Nkonya} & reduced & complex\\
\padding
...
\citet{Snider1988} deduced the ``noun class'' system of Proto-\ili{Guang} by looking at the noun prefixes of nine of the 18 family members without mentioning at all possible agreement forms. He observed a major difference between Northern and Southern \ili{Guang}, the former being richer in nominal form classes, and concluded (ibid.:~138):
...
\midrule
\multirow{3}{*}{\rotatebox[origin=r]{90}{\ili{Na-Togo}}} & \ili{Anii}, \ili{Adele}, \ili{Lelemi}, \ili{Siwu}, \ili{Sekpele}, \ili{Selee}, \ili{Logba} & complex & complex\\
\padding
& \ili{Boro} (†) & no information & no information\\
\padding
\multirow{3}{*}{\rotatebox[origin=r]{90}{\ili{Ka-Togo}}} & \ili{Avatime}, \ili{Nyangbo}, \ili{Tafi}, \ili{Tuwuli}, Akebu & complex & complex\\
\padding
...
AN  	&	 animate & \textsc{part} 	&	  participle	\\
CONC  	&	 pronominal concord &	\textsc{perf}  	&	 perfect	\\
\textsc{d} 	&	  distal 	&	PRO  	&	 pronoun	\\
